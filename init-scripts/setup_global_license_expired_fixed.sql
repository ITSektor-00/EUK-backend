-- Setup Global License as EXPIRED (Fixed Version)
-- This script creates a global license that is already expired for testing
-- It handles the single_global_license constraint
...
-- Clear ALL existing global licenses (to avoid constraint violation)
