...
public class EukUgrozenoLiceT2 {
    ...
    @Column(name = "redni_broj", nullable = false, length = 20, columnDefinition = "VARCHAR(20)")
    private String redniBroj;
    
    @NotBlank(message = "Ime je obavezno")
    @Size(max = 100, message = "Ime ne može biti duže od 100 karaktera")
    @Column(name = "ime", nullable = false, length = 100, columnDefinition = "VARCHAR(100)")
    private String ime;
    
    @NotBlank(message = "Prezime je obavezno")
    @Size(max = 100, message = "Prezime ne može biti duže od 100 karaktera")
    @Column(name = "prezime", nullable = false, length = 100, columnDefinition = "VARCHAR(100)")
    ...
    @Column(name = "ed_broj", length = 100, columnDefinition = "VARCHAR(100)")
    ...
    @Column(name = "pok_vazenja_resenja_o_statusu", length = 200, columnDefinition = "VARCHAR(200)")
